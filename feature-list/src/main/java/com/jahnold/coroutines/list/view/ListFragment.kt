...
class ListFragment: BaseFragment() {
    ...
    private fun initSearch() {
        ...
        val search = arguments?.getString(ARG_SEARCH) ?: throw IllegalStateException("Search is required")
        viewModel.loadListState(search)
    }
    ...
    companion object {
        ...
        fun create(search: String): ListFragment {
